...
### (日本) Buffering facet configuration
...
### (日本) Health endpoints facet configuration
...
## (日本) OMF egress data endpoints facet configuration
...
### (日本) Logging facet configuration
...
### (日本) Schedules facet configuration
...
### (日本) Data filters facet configuration
...
### (日本) Data source facet configuration
...
### (日本) Data selection facet configuration
...
### (日本) General facet configuration
...
## (日本) EDS configuration

### (日本) Storage configuration
