...
### (JA) Buffering facet configuration
...
### (JA) Health endpoints facet configuration
...
## (JA) OMF egress data endpoints facet configuration
...
### (JA) Logging facet configuration
...
### (JA) Schedules facet configuration
...
### (JA) Data filters facet configuration
...
### (JA) Data source facet configuration
...
### (JA) Data selection facet configuration
...
### (JA) General facet configuration
...
## (JA) EDS configuration

### (JA) Storage configuration
